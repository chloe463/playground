              ...
              <Link href={page.url}>
                <a
                  className={
                    ...
                    `,
                    {
                      "text-black-alpha800": props.currentPathName === page.url,
                      "text-black-alpha500": props.currentPathName !== page.url
                    },
                  )}
                >
                  <div className={
                    classnames(
                      ...
                      {
                        "bg-black-alpha500": props.currentPathName === page.url,
                        "bg-black-alpha400": props.currentPathName !== page.url,
                      }
                    )
                  } />
                  {page.name}
