...
export const PostPlaceholder: React.VFC = () => {
  return (
    <div className="relative flex items-center py-4 px-6">
      ...
      <div className="ml-4">
        <header>
          <div className="w-[180px] h-[22px] m-0 p-0 bg-black-alpha100 rounded-full text-lg"/>
        </header>
        <div className="mt-3">
          <p className="block m-0 p-0 text-base w-[240px] h-[18px] bg-black-alpha100 rounded-full" />
        </div>
      </div>
      <ShimmerBg />
    </div>
